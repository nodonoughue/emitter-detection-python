...
def log_likelihood_uncertainty(x_sensor, zeta, cov: CovarianceMatrix, cov_pos: CovarianceMatrix, theta, do_2d_aoa=False,
    ...
    beta = x_sensor.ravel()  # Assume the x_aoa positions provided are truth.
