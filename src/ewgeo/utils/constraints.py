...
def fixed_alt_constraint_sphere(x: npt.ArrayLike, alt: float):
    ...
    radius of the Earth (radius_earth_true) will be subtracted from the norm before comparing to the
    altitude constraint.
