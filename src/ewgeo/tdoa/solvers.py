...
#     """
#     Construct the ML Estimate with uncertainty. Uses the utility function make_uncertainty_search_space to handle
...
#                      'x_tdoa': x_sensor}
#     search_center, search_size, search_resolution, param_indices = make_uncertainty_search_space(**search_params)
#
#     # Set up function handle
#     # We must take care to ensure that it can handle an n_th x N matrix of
#     # inputs; for compatibility with how ml_solver will call it.
#     def ell(theta):
...
#
#     # Call the util function
#     th_est, likelihood, x_grid = ml_solver(ell=ell, x_ctr=x_ctr, search_size=search_size, epsilon=epsilon, **kwargs)
#
