...
def vid4_1():
    ...
    Note: the original MATLAB script includes a line-of-sight terrain profile
    generated by los2() with a NASA DEM file (nasadem_washingtondc.tif). That
    visualization is omitted here because it requires an external DEM file and
    a specialised terrain-analysis library with no standard Python equivalent.
    ...
    :return: empty tuple (no figures generated)
    """
